...
class TransactionRecord(models.Model):
    ...
    auditor_status = models.SmallIntegerField(verbose_name="审核", choices=auditor_status_choices, null=True, blank=True)
    auditor = models.ForeignKey(verbose_name="审核员", to="Administrator", on_delete=models.CASCADE, null=True, blank=True)
